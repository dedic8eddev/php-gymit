 ...
 */
$config['site_title']                 = "Cavixoapp.com";       // Site Title, example.com
$config['admin_email']                = "admin@cavixoapp.com"; // Admin Email, admin@example.com
$config['default_group']              = 'publisher';           // Default group, use name
