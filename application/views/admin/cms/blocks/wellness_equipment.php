<input type="hidden" name="block_wellness_equipment[id]" value="<?php echo $block_wellness_equipment['id']; ?>" />
<input type="hidden" name="block_wellness_equipment[name]" value="<?php echo $block_wellness_equipment['name']; ?>" />
<div class="row px-3">
    <?php if(isset($block_wellness_equipment['images'])) foreach ($block_wellness_equipment['images'] as $e): ?>
        <div class='imgCol col-md-2'><div class="aspect16_15 image-preview uploaded" style="min-height:0; cursor:default; background-image:url('<?php echo $e; ?>');"></div>
            ...
            <input type="hidden" name="block_wellness_equipment[images][]" value="<?php echo $e; ?>" />
        </div>
    <?php endforeach; ?>
    <div class="imgCol col-md-2 js-media-input-container mb-2">
        <div class="js-media-open-modal-btn">
            ...
            <input type="hidden" value='<?php echo @$service['header_image']; ?>' class="js-media-input-target-id" data-input-name="block_wellness_equipment">
        </div>  
    </div>         
</div>