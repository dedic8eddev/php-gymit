    ...
    <div class="headerTopOverlay small">
      <div class="container">
        <div class="headerContainer">
          ...
          <h1 class="headerTitle">Členství platinum</h1>
        </div>
      </div>
    </div>
    <div class="headerBottomOverlay">
      <div class="container">
        <div class="flexRow four mb0">
          <div class="col anim1-150 js-tabTitle active js-platinum js-unlimited" data-tab="0">
            <h3 class="cTitle">Unlimited</h3>
            <div class="cPrice">650<span><strong>Kč</strong> měsíčně</span></div>
            <div class="arrow anim1-150"></div>
          </div>
          <div class="col anim1-150 js-tabTitle js-platinum js-student" data-tab="1">
        ...
        <div class="left">
          <div class="js-tabContent" data-tab="0">
            <div class="wysiwygContent">
              <h3 class="cTitle">Platinum Unlimited</h3>
              <ul>
          ...
          <div class="js-tabContent" data-tab="1" style="display:none;">
           <div class="wysiwygContent">
              <h3 class="cTitle">Platinum Student</h3>
              <ul>
                <li>Neomezený vstup do posilovny, na skupinové lekce a wellness</li>
                <li>V ceně členství nabízíme ručníkový servis</li>
              </ul>
          ...
          <div class="wysiwygContent">
            ...
            <img src="<?php echo base_url(); ?>public/landingpage/img/darek_detail_platinum.jpg" alt="" />
          </div>
        </div>
        <div class="right">
              ...
              <div class="col">
                <div class="input">
                  <select name="membership_id" class="styleSelect" id="membershipSelect" aria-invalid="false">
                    <option data-price="7 794" value="9">Platinum (Roční členství)</option>
                    <option data-price="5 994" value="14" disabled>Platinum student (Roční členství)</option>
                  </select>
                </div>
              </div>
            </div>
